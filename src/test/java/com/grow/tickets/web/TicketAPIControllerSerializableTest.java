...
class TicketAPIControllerSerializableTest extends TicketAPIControllerTest{
    private static final String ISOLATION_LEVEL = "serializable";
    ...
    @Test
    public void shouldNotPhantomRead() throws Exception {
